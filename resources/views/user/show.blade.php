              ...
              <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <div class="mb-4 text-center">
                    @if ($product->shop->filename !== null)
                      <img class="w-40 h-40 m-auto object-cover rounded-full" src="{{ asset('storage/shops/' . $product->shop->filename) }}">
                    @else
                      <img src="">
                    @endif
                  </div>
                  <div class="mb-4 text-center">
                    <button type="button" data-micromodal-trigger="modal-1" href='javascript:;' class=" text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細</button>
                  </div>
              </div>
          </div>
      </div>
    ...
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
      <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
        <header class="modal__header">
          <div class="text-xl text-gray-700" id="modal-1-title">
            {{ $product->shop->name }}
          </div>
